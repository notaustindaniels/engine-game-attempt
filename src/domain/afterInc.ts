...
export const afterIncDomain: DomainSchema = {
  ...
  lexicon: {
    ...
    // Runtime UI language (the playable game speaks each domain's tongue).
    'runtime.chooseLeader': { label: 'Choose your leader' },
    'runtime.defenders': { label: 'Fighters' },
    'runtime.stat.morale': { label: 'Morale' },
    'runtime.stat.authority': { label: 'Authority' },
    'runtime.stat.stamina': { label: 'Stamina' },
    'runtime.stat.population': { label: 'Population' },
    'runtime.stat.housing': { label: 'Housing' },
    'runtime.stat.pressure': { label: 'Zombie threat' },
    'runtime.stat.tech': { label: 'Technology' },
    'runtime.action.explore': { label: 'Explore' },
    'runtime.action.claim': { label: 'Claim' },
    'runtime.action.deal': { label: 'Scavenge' },
    'runtime.action.move': { label: 'Deploy fighter' },
    'runtime.action.cleanse': { label: 'Cleanse' },
    'runtime.action.provoke': { label: 'Provoke attack' },
    'runtime.action.festival': { label: 'Hold festival' },
    'runtime.action.train': { label: 'Train fighter' },
    'runtime.action.housing': { label: 'Build housing' },
    'runtime.action.storage': { label: 'Expand storage' },
    'runtime.action.research': { label: 'Research technology' },
    'runtime.log.explored': { label: 'Area explored' },
    'runtime.log.claimed': { label: 'Area claimed' },
    'runtime.log.areaLost': { label: 'Area overrun' },
    'runtime.log.cleansed': { label: 'Infestation cleansed' },
    'runtime.log.defenderDown': { label: 'Fighter lost' },
    'runtime.log.defenderTrained': { label: 'Fighter trained' },
    'runtime.log.goalComplete': { label: 'Goal complete' },
    'runtime.log.goalOverdue': { label: 'Goal overdue — settlers grow impatient' },
    'runtime.log.festival': { label: 'Festival held' },
    'runtime.log.growth': { label: 'A settler arrives' },
    'runtime.log.abandonment': { label: 'A settler abandons the settlement' },
    'runtime.log.attack': { label: 'The settlement is under attack' },
    'runtime.log.techUp': { label: 'Technology advanced' },
    'runtime.log.milestone': { label: 'Map milestone reached' },
    'runtime.log.event': { label: 'A development unfolds' },
    'runtime.outcome.won': { label: 'The settlement endures' },
    'runtime.outcome.won.desc': {
      label: 'The settlement endures',
      description: 'Every goal is complete. The living have a future here.',
    },
    'runtime.outcome.lost': { label: 'The settlement has fallen' },
    'runtime.outcome.lost.desc': {
      label: 'The settlement has fallen',
      description: 'Authority is spent and the gates stand open. The story ends here.',
    },
  },
  pools: {
