...
export function buildNicheDomain(pack: NichePack): DomainSchema {
  ...
  return {
    ...
    lexicon: {
      ...
      // Runtime UI language (business-native per the Native Translation rule).
      'runtime.chooseLeader': { label: 'Choose your founder archetype' },
      'runtime.defenders': { label: 'Retention specialists' },
      'runtime.stat.morale': { label: `${capitalize(team)} morale` },
      'runtime.stat.authority': { label: 'Credibility' },
      'runtime.stat.stamina': { label: 'Attention' },
      'runtime.stat.population': { label: 'Headcount' },
      'runtime.stat.housing': { label: 'Org capacity' },
      'runtime.stat.pressure': { label: capitalize(pack.pressureLabel) },
      'runtime.stat.tech': { label: 'Platform maturity' },
      'runtime.action.explore': { label: 'Research segment' },
      'runtime.action.claim': { label: 'Enter market' },
      'runtime.action.deal': { label: 'Source a one-off deal' },
      'runtime.action.move': { label: 'Deploy specialist' },
      'runtime.action.cleanse': { label: 'Run a turnaround' },
      'runtime.action.provoke': { label: 'Force the issue' },
      'runtime.action.festival': { label: 'Team offsite' },
      'runtime.action.train': { label: 'Hire retention specialist' },
      'runtime.action.housing': { label: 'Grow the org' },
      'runtime.action.storage': { label: 'Expand capacity' },
      'runtime.action.research': { label: 'Mature the platform' },
      'runtime.log.explored': { label: 'Segment researched' },
      'runtime.log.claimed': { label: 'Market entered' },
      'runtime.log.areaLost': { label: 'Market position collapsed' },
      'runtime.log.cleansed': { label: 'Pressure source resolved' },
      'runtime.log.defenderDown': { label: 'Specialist burned out' },
      'runtime.log.defenderTrained': { label: 'Specialist hired' },
      'runtime.log.goalComplete': { label: 'Milestone hit' },
      'runtime.log.goalOverdue': { label: 'Milestone overdue — the board grows restless' },
      'runtime.log.festival': { label: 'Offsite held' },
      'runtime.log.growth': { label: 'A new hire joins' },
      'runtime.log.abandonment': { label: 'A regrettable departure' },
      'runtime.log.attack': { label: 'The home base is under pressure' },
      'runtime.log.techUp': { label: 'Platform matured' },
      'runtime.log.milestone': { label: 'Market coverage recognized' },
      'runtime.log.event': { label: 'A development unfolds' },
      'runtime.outcome.won': { label: 'A durable business' },
      'runtime.outcome.won.desc': {
        label: 'A durable business',
        description: `Every milestone is met. The ${venture} has become an institution.`,
      },
      'runtime.outcome.lost': { label: 'The venture folds' },
      'runtime.outcome.lost.desc': {
        label: 'The venture folds',
        description: 'Credibility is spent and the backers have moved on.',
      },
    },
    pools: {
      resources: [
